...
SECRET_KEY = 'django-insecure-xo#tklv-(5qbn1enyzt+(jl7r1v$cjh=(y^+4-m-bqnk=a044q'
...
ROOT_URLCONF = 'Desarrollo_Web.urls'
...
WSGI_APPLICATION = 'Desarrollo_Web.wsgi.application'
